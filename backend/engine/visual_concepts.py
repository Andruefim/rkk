...
# Mapping: slot property → likely visual concepts
# Used by SlotLabeler to map VLM descriptions → concept names
SLOT_PROPERTY_TO_CONCEPTS: dict[str, list[str]] = {
    # Color
    "green":     ["GREEN_OBJECT", "COOL_COLOR"],
    "blue":      ["BLUE_OBJECT", "COOL_COLOR", "GLOWING_OBJECT"],
    "red":       ["RED_OBJECT", "WARM_COLOR"],
    "orange":    ["ORANGE_OBJECT", "WARM_COLOR"],
    "white":     ["WHITE_OBJECT"],
    "bright":    ["BRIGHT_OBJECT", "GLOWING_OBJECT"],
    "glow":      ["GLOWING_OBJECT", "BRIGHT_OBJECT", "SENSOR_PLATE_VISIBLE"],
    # Shape
    "sphere":    ["SPHERE_DETECTED", "BALL_DETECTED", "CAN_PUSH"],
    "ball":      ["SPHERE_DETECTED", "BALL_DETECTED", "CAN_PUSH"],
    "cube":      ["CUBE_DETECTED", "CAN_PUSH", "CONTAINER_DETECTED"],
    "box":       ["CUBE_DETECTED", "CAN_PUSH", "CONTAINER_DETECTED"],
    "cylinder":  ["CYLINDER_DETECTED"],
    "flat":      ["FLAT_SURFACE", "SURFACE_WALKABLE"],
    "ramp":      ["RAMP_DETECTED", "INCLINED_SURFACE", "SURFACE_CHALLENGING", "CAN_CLIMB"],
    "stairs":    ["STAIRS_DETECTED", "SURFACE_CHALLENGING", "CAN_CLIMB"],
    "beam":      ["BEAM_DETECTED", "NARROW_OBJECT", "SURFACE_CHALLENGING"],
    "platform":  ["PLATFORM_DETECTED", "ELEVATED_SURFACE", "FLAT_SURFACE"],
    "plate":     ["MARKER_DETECTED", "SENSOR_PLATE_VISIBLE", "FLAT_SURFACE"],
    "step":      ["ELEVATED_SURFACE", "FLAT_SURFACE", "CAN_CLIMB"],
    # Size
    "large":     ["LARGE_OBJECT", "MUST_GO_AROUND"],
    "small":     ["SMALL_OBJECT", "CAN_STEP_OVER", "CAN_PUSH"],
    "tall":      ["TALL_OBJECT", "LARGE_OBJECT"],
    "narrow":    ["NARROW_OBJECT", "SURFACE_CHALLENGING"],
    "wide":      ["FLAT_SURFACE", "SURFACE_WALKABLE"],
    # Distance (from slot position in image)
    "close":     ["OBJECT_CLOSE", "OBJECT_VERY_CLOSE", "COLLISION_RISK"],
    "near":      ["OBJECT_CLOSE", "CAN_REACH"],
    "far":       ["OBJECT_FAR", "OBJECT_MEDIUM"],
    "center":    ["OBJECT_AHEAD", "OBJECT_BLOCKING_PATH"],
    "left":      ["OBJECT_LEFT", "ATTENDING_LEFT"],
    "right":     ["OBJECT_RIGHT", "ATTENDING_RIGHT"],
    # Scene
    "empty":     ["OPEN_SCENE", "CLEAR_PATH_AHEAD"],
    "clear":     ["CLEAR_PATH_AHEAD", "OPEN_SCENE"],
    "wall":      ["WALL_NEARBY", "BOUNDARY_NEAR"],
    "multiple":  ["MULTIPLE_OBJECTS", "CLUTTERED_SCENE"],
    # Motion
    "moving":    ["OBJECT_MOVING", "SLOT_CHANGED"],
    "static":    ["OBJECT_STATIC", "SCENE_STABLE"],
    "rolling":   ["ROLLING_OBJECT", "SPHERE_DETECTED"],
}
